...
index: 5
metaDescription: 'Developer Hans Jansen contributes GNU indirect functions (ifuncs) to optimize XZ Utils, sparking friction with memory checkers and Google OSS-Fuzz.'
---
