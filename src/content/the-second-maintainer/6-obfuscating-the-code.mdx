...
index: 6
metaDescription: 'Jia Tan injects the backdoor into XZ Utils 5.6.0, targeting OpenSSH via Systemd and hiding the malicious payload inside obfuscated test files.'
---
