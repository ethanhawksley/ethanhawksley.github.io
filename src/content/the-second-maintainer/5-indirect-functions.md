...
_CRC32_ is just a smaller version of _CRC64_, which is slightly less accurate but faster to compute. Hans' patch only changed the _CRC64_ function, but it was simple enough that Jia could follow his footsteps to implement it for _CRC32_ too.
