...
```json
{
  ...
  "description": "The personal site and technical blog of Ethan Hawksley, a Computer Science student in the UK with a focus on systems programming and cybersecurity.",
  "inLanguage": "en",
  "publisher": {
...
```json
{
  ...
  "name": "Elsewhere",
  "description": "Online profiles of Ethan Hawksley, a Computer Science student in the UK. Links to his development, social media, technical writing, and security accounts.",
  "inLanguage": "en",
  "about": {
    "@id": "https://hawksley.dev/#person"
  },
...
```json
{
  ...
  "description": "Technical blog of Ethan Hawksley, a Computer Science student in the UK. Articles on systems programming, cybersecurity, and whatever else grabs my attention.",
  "inLanguage": "en",
  "dateModified": "2026-05-17T00:00:00.000Z",
  "publisher": {
    "@id": "https://hawksley.dev/#person"
